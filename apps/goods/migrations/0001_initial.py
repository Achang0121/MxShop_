# Generated by Django 2.2 on 2020-06-01 06:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_font_image', models.ImageField(blank=True, null=True, upload_to='goods/images/', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.CharField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '三级类目')], default=1, help_text='类别类型', max_length=10, verbose_name='类别类型')),
                ('is_tab', models.BooleanField(default=False, help_text='是否在导航栏', verbose_name='是否在导航栏')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
